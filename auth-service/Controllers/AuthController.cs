...
namespace auth_service.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        // Aliases for provider-specific callback paths expected by providers
        [HttpGet("/signin-google")]
        public Task<IActionResult> GoogleSigninAlias([FromQuery] string code, [FromQuery] string state)
            => ExternalCallback(code, state, "Google");

        [HttpGet("/signin-twitter")]
        public Task<IActionResult> TwitterSigninAlias([FromQuery] string code, [FromQuery] string state)
            => ExternalCallback(code, state, "Twitter");
    }
}
