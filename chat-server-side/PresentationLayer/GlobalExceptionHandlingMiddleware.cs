...
namespace PresentationLayer
{
    public class GlobalExceptionHandlingMiddleware : IMiddleware
    {
        ...
        private async Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            var allowedOrigins = new[] { "http://localhost:3000", "http://localhost:3001", "http://localhost:8081", "http://localhost:19000", "http://localhost:19006", "http://127.0.0.1:3000", "http://127.0.0.1:3001", "http://127.0.0.1:8081", "http://10.0.2.2:8081", "https://wishera.vercel.app" };
