...
namespace WisheraApp.Controllers
{
    ...
    public class WishlistsController : ControllerBase
    {
        ...
        [HttpGet("liked")]
        public async Task<ActionResult<List<WishlistFeedDTO>>> GetLikedWishlists(
            ...
            [FromQuery] int pageSize = 20)
        {
            ...
            var likedWishlists = await _giftWishlistServiceClient.GetLikedWishlistsAsync(currentUserId, page, pageSize);
