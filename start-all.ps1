...
# Chat Service
Write-Host "Запускаю Chat Service на порту 5162..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'C:\Users\yusufova_a\WishlistWebApp\chat-server-side\PresentationLayer'; dotnet run --urls http://localhost:5162"
